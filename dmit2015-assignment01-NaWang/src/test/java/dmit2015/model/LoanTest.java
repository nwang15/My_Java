...
public class LoanTest {
	  ...
	  public void testGetMonthyPayment()
	  {
		...
		assertEquals(1495.56, loanBean.getMonthlyPayment(), 0.00);

		loanBean = new Loan(250000, 3.09, 25);
		assertEquals(1194.69, loanBean.getMonthlyPayment(), 0.00);

		loanBean = new Loan(250000, 5.29, 20);
		assertEquals(1682.18, loanBean.getMonthlyPayment(), 0.00);
